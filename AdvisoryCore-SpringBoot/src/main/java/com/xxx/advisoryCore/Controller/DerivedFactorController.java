...
public class DerivedFactorController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Map<String, Object>>>> getDerivedFactorDataTypes() {
        try {
            System.out.println("11111");
            Map<String, Map<String, Object>> dataTypes = derivedFactorService.getDerivedFactorDataTypes();
