...
class FundOptionsPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(135:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(136:7)", "entry");
            Scroll.width('100%');
            Scroll.height('100%');
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(137:9)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(138:11)", "entry");
            Column.padding(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(139:13)", "entry");
            Row.margin({ bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('基金备选库');
            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(140:15)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(144:15)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`共 ${this.total} 条记录`);
            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(145:15)", "entry");
            Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(151:13)", "entry");
            List.layoutWeight(1);
            List.width('100%');
            List.divider({
                strokeWidth: 1,
            ...
            const forEachItemGenFunction = _item => {
                const row = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(153:17)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Column.create();
                            Column.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(154:19)", "entry");
                            Column.padding(18);
                            Column.backgroundColor('#FFFFFF');
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(155:21)", "entry");
                            Row.margin({ bottom: 8 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create(row.fund_name ?? '');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(156:23)", "entry");
                            Text.fontSize(16);
                            Text.fontWeight(FontWeight.Bold);
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Blank.create();
                            Blank.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(157:23)", "entry");
                        }, Blank);
                        Blank.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create(row.fund_code ?? '');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(158:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#86909C');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(162:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('基金经理:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(163:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(164:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(168:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('类型:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(169:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(170:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(174:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('运行周期:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(175:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(176:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(180:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('最新净值:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(181:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(182:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(186:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('净值日期:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(187:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(188:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(192:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('基金规模:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(193:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(194:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(198:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('近一月收益率:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(199:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(200:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(204:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('今年以来收益率:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(205:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(206:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(210:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('最大回撤:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(211:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(212:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(216:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('成立日期:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(217:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(218:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(222:21)", "entry");
                            Row.margin({ bottom: 2 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('评分:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(223:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#666');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(224:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#333');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(228:21)", "entry");
                            Row.margin({ bottom: 10 });
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create('预警:');
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(229:23)", "entry");
                            Text.fontSize(12);
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(230:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#F53F3F');
                            Text.margin({ right: 8 });
                        }, Text);
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(231:23)", "entry");
                            Text.fontSize(12);
                            Text.fontColor('#F53F3F');
                        }, Text);
                        Text.pop();
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(235:21)", "entry");
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Button.createWithLabel('出库', { type: ButtonType.Normal });
                            Button.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(236:23)", "entry");
                            Button.width(60);
                            Button.height(32);
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Button.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(245:23)", "entry");
                            Button.width(80);
                            Button.height(32);
                            Button.backgroundColor('#F0F5FF');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(272:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(273:15)", "entry");
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(283:15)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('→', { type: ButtonType.Circle });
            Button.debugLine("entry/src/main/ets/pages/FundOptionsPage.ets(288:15)", "entry");
            Button.onClick(() => {
