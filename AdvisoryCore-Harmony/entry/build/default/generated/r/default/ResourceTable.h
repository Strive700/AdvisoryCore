...
const int32_t STRING_PAGE_SHOW = 0x010000b8;
...
const int32_t MEDIA_LOGIN_METHOD1 = 0x010000a3;
const int32_t MEDIA_LOGIN_METHOD2 = 0x010000a4;
const int32_t MEDIA_LOGIN_METHOD3 = 0x010000a5;
